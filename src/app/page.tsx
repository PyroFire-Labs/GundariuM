      ...
      <section id="game-loop" className="px-4 py-20 bg-[var(--surface)]">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3 items-center">
            {[
              { step: "01", Icon: Dices,    title: "ROLL YOUR TRAITS", desc: "Pick a faction and roll unique kitbash traits — frame, weapons, colorway, and more. ~69 million possible combinations." },
              { step: "02", Icon: Sparkles, title: "AI GENERATES",     desc: "Gemini AI renders a unique Mobile Suit from your traits — no two cards are the same." },
              { step: "03", Icon: Swords,   title: "MINT & BATTLE",    desc: "Mint your card as an NFT on Base and build your battle team." },
            ].map((item, i) => (
              <div key={item.step} className="relative flex flex-col items-center text-center">
                ...
                <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full border border-[var(--accent)]/40 bg-[var(--accent)]/10">
                  <item.Icon size={36} strokeWidth={1.5} className="text-[var(--accent)]" />
                </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {[
              ...
              >
                <div className="mb-3">
                  <f.Icon size={28} strokeWidth={1.75} className="text-[var(--accent)]" />
                </div>
            ...
            {[
              ...
              <div key={u.label} className="rounded-xl border border-[var(--border)] bg-[var(--surface-2)] p-5 text-center">
                <div className="mb-2 flex justify-center">
                  <u.Icon size={24} strokeWidth={1.75} className="text-[var(--accent)]" />
                </div>
