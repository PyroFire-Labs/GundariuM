      ...
      <div className="prose prose-invert prose-sm max-w-none space-y-6 text-[var(--foreground)]/80 text-sm leading-relaxed">
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Stake and earn GNRM tokens</li>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Ensuring you have sufficient funds (USDC, ETH, GNRM) for transactions</li>
          </ul>
          <p>
        ...
        <section>
          <h2 className="font-[family-name:var(--font-orbitron)] text-lg text-[var(--foreground)] mb-3">6. GNRM Token</h2>
          <p>
            GNRM is a utility token used within the GundariuM ecosystem for staking, battle entry fees, and rewards. GNRM is not an investment, security, or financial instrument. We make no representations regarding the future value of GNRM tokens.
          </p>
          <p>
            Staking GNRM is subject to the lock, unstaking, and reward-claiming rules of the third-party staking contract used (currently Streme.fun), which we do not control and cannot override.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>Engage in market manipulation of GNRM tokens or Gunpla Cards</li>
